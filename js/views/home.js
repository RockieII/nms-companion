...
const TOOL_SVG = {
  ...
  browse: '<svg viewBox="0 0 24 24"><path fill="currentColor" d="M12 2 3 7v10l9 5 9-5V7z" opacity=".3"/><path fill="currentColor" d="M12 2 3 7l9 5 9-5z"/></svg>',
};
...
export async function renderHome(root) {
  ...
  hub.appendChild(el('div', { class: 'tools' }, [
    ...
    tool('Browse', '#browse', TOOL_SVG.browse),
  ]));
